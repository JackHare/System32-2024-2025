...
public class Arm1 {
    ...
    private final int MAX_POSITION = 2600; //TODO FIND VALUE
    private  final int MIN_POSITION = 200; //TODO FIND VALUE
    ...
    public Arm1(HardwareMap hardwareMap) {
        ...
        this.limitSwitch = hardwareMap.get(TouchSensor.class,"Arm1Limit");
    }
