...
public class Arm3 {
    private final int MAX_POSITION = 2500; //TODO FIND VALUE
    private  final int MIN_POSITION = 50; //TODO FIND VALUE
    ...
    public Arm3(HardwareMap hardwareMap) {
        motor = hardwareMap.get(DcMotor.class, "Arm3");
        motor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        this.limitSwitch = hardwareMap.get(TouchSensor.class,"Arm3LimitMin");
    }
